...
try:
    while True:
        ...
        print(f'axis_value {axis_value}')

        # Map the controller input to LED brightness
        brightness = int((axis_value - AXIS_MIN) / (AXIS_MAX - AXIS_MIN) * (MAX_BRIGHTNESS - MIN_BRIGHTNESS) + MIN_BRIGHTNESS)
